...
#writer for storing webscraped data to .csv file
...
try:
    ...
    #except was added here as there are times where indeed website will not show the max generated pages
...
try:
    if max_page_by_user <= 1:
        ...
        # if pages are set to more than1, for loop will loop based on the number of max pages. It will generate the URL first then execute the webscraping per page then loop through until last page is reached.
        csv_maker()
